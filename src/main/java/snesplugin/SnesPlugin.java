...
//   private static final Icon SNES_ICON =
// ResourceManager.loadImage("images/Super_Famicom_logo.png");
...
//     displayMirrorsAction.setSelected(opts.getBoolean(SnesCommon.OPT_MEMORY_DISPLAY_MIRRORS,
// false));
//   }
...
//    *
//    * Matching is intentionally namespace-based so user-created blocks are not removed by
// accident.
//    *
...
//    *
//    * The canonical HiROM ROM banks are mapped at {@code C0-FF:0000-FFFF}. The mirror windows
// expose
...
//    */
//   private int createHiRomHalfMirrorBlock(Program program, MemoryBlock sourceBlock, int
// mirrorBank)
//       throws Exception {
